    ...
    try {
      ...
      <div style="font-family: sans-serif; max-width: 500px; border: 1px solid #eee; padding: 20px; border-radius: 15px;">
        ...
        <div style="display: flex; gap: 10px; justify-content: center;">
          <a href="${zaloLink}" style="display: inline-block; background: #0068ff; color: white; padding: 12px 25px; text-decoration: none; border-radius: 8px; font-weight: bold; margin-right: 10px;">💬 Nhắn Zalo</a>
